 ...
 * File: comp_test_accuracy.sv
 * Author: Denis Kucera
 * Created: 2026-05-30
 * Description: Accuracy test
 */

class comp_test_accuracy extends comp_base_test;

    `uvm_component_utils(comp_test_accuracy)
...
virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TEST", "Running Accuracy Test", UVM_LOW)
