 ...
 * File: comp_test_disable_function.sv
 * Author: Denis Kucera
 * Created: 2026-05-30
 * Description: Disable + UVLO function test
 */

class comp_test_disable_function extends comp_base_test;

    `uvm_component_utils(comp_test_disable_function)
...
virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TEST", "Running Disable + UVLO function Test", UVM_LOW)
